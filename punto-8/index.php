...
<h2>
    Dado el tipo de afiliación y el número de personas digitados el usuario generar el 
    valor de las entradas a la bolera teniendo en cuenta que si el tipo de afiliación  
    es ‘A’  tendrá un descuento del  30% del total si es tipo ‘B’ el 25%, si es tipo ‘C’ 
    del 10% y si es tipo ‘D’ del 5%, el valor es de $25.000 por persona.
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    switch ($tipoAfiliacion) {
        ...
        default:
            ...
            echo "Tipo de afiliación inválido.";
            exit();
    }
...
<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    <label for="tipo_afiliacion">Tipo de afiliación (A, B, C, o D):</label>
